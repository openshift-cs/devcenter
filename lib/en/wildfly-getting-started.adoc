...
nav_priority: 10
meta_desc: Get started with WildFly on OpenShift
---
...
OpenShift also supports *WAR* files deployment. There are several processes which are each very simple. Please visit the link:/en/wildfly-deployment-options.html[deployment options] page for more information.
