...
Where do I go for support?::
  The best places to go for support are the link:/help[Help Center] or the link:https://community.jboss.org/en/jbpm[BPM Suite community boards]. We would love to have your input so go where you're most comfortable and we will see it.
