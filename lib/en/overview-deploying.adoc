...
IMPORTANT: Learn how to use Git by reviewing the basic concepts of Git version control. Try out this 15-minute introductory course by Code School and GitHub. -> link:https://www.codeschool.com/courses/try-git[START COURSE]
