...
nav_title: JBossAS/Wildfly
nav_priority: 1.2
meta_desc: JBossAS Developers - OpenShift Resources to host your Java applications in the cloud.
---
= JBossAS Overview
...
[[java]]
[float]
= JBossAS Application Hosting

[[jbossas]]
== The JBossAS / Wildfly Cartridge
[.lead]
Provides the JBossAS application server on OpenShift. OpenShift Online currently supports `JBossAS 7.1` and `8.0`.
