...
IMPORTANT: OpenShift provides link:managing-environment-variables.html[environment variables] that the application is supposed to consume as a way to configure itself.
