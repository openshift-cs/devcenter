...
The following tables show the variables, some examples of what the value would be, and what you might use them for. Depending on what extra cartridges you have enabled in your application, you may have more or fewer available variables. Also, values
...
include::_fragments/managing-reading-environment-variables.adoc[]
