...
Please check the link:https://access.redhat.com/site/documentation/en-US/Red_Hat_JBoss_Fuse/6.1/html/Cloud_Deployment_Guide/index.html[Cloud deployment guide] to deploy JBoss Fuse for xPaaS on OpenShift Enterprise.
