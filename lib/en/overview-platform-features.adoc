...
=== Command Line Tools
To view available regions or create an application using a specific region, you can use the OpenShift RHC Command Line Tools (rhc). If you haven't set up RHC, please link:getting-started-client-tools.html[visit this installation guide] first and make sure your version is up to date.
...
[source]
--
$ rhc app create racer php-5.4 --gear-size medium --region aws-eu-west-1a --scaling
--
