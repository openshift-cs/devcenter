...
description: Get started with JBoss EAP 6 on OpenShift
---
...
OpenShift also supports *WAR* files deployment. There are several processes which are each very simple. Please visit the link:/servers/jbosseap/deployment-options.html[deployment options page] for more information.
