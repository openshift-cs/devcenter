...
description: JBoss AS OpenShift deployment options
---


[float]
= JBoss AS Deployment Options
...
NOTE: If you are running scaled JBoss AS then you need an application deployed to the root context (i.e. _\http://app_name-namespace.rhcloud.com/_) for the HAProxy load-balancer to recognize that the JBoss AS instance is active.
